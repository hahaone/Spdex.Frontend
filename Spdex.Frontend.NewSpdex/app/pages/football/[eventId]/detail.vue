...
// 经典版「完整明细」（还原旧站 op1 Match/View/Normal + Details）。
// 市场感知：明细(standard 主/平/客) / 进球明细(goals 大/小) / 比分明细(cs 热门比分)。
// tab：综合明细 + 各选项明细（后者带卖方/买方挂牌三档）。
    ...
    <section class="dp-card">
      ...
      <div class="dp-head">
        <div class="dp-head-left">
          <NuxtLink to="/football?view=classic" class="dp-back"><ArrowLeft :size="14" /><span>返回列表</span></NuxtLink>
          <h1>{{ pageTitle }}</h1>
        ...
        <div class="dp-head-right">
          ...
          <NuxtLink :to="`/football/${eventId}/trades`" class="dp-bignote">大注提示 »</NuxtLink>
